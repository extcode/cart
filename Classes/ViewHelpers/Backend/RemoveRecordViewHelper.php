<?php
namespace Extcode\Cart\ViewHelpers\Backend;
...
class RemoveRecordViewHelper extends AbstractViewHelper
{
    ...
    public function initializeArguments()
    {
        ...
        $this->registerArgument('product', \Extcode\Cart\Domain\Model\Product\Product::class, 'product to remove', true);
    }
    ...
    public static function renderStatic(array $arguments, \Closure $renderChildrenClosure, RenderingContextInterface $renderingContext)
    {
        ...
        $urlParameters = [
            'cmd[tx_cart_domain_model_product_product][' . $product->getUid() . '][delete]' => 1,
            'prErr' => 1,
            'uPT' => 1,
